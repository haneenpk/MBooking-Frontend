  ...
  if (!isBlocked) {
    return (
      <div className="flex justify-center items-center mt-24">
        <div className="max-w-xl mx-auto px-11 rounded-md shadow-md bg-gray-300 py-32">
          <div className="flex flex-col md:flex-row items-center md:items-start">
            ...
            <div className="mt-6 md:mt-0 border-l-2 pl-6 border-gray-600">
              ...
              <NavLink to="/edit-profile" className="bg-green-500 hover:bg-green-600 text-white font-bold py-2 px-4 rounded mr-2">
                Edit Profile Details
              </NavLink>
              <button onClick={handleLogout} className="bg-gray-500 hover:bg-gray-600 text-white font-bold py-2 px-4 rounded">
                Logout
              </button>
            </div>
          </div>
