        ...
        return (
            <div className="max-w-md mx-auto my-10 p-6 bg-white rounded-md shadow-md">
                ...
                <div className="mb-4">
                    ...
                    <input type="text" id="email" name="email" value={formData.email} onChange={handleChange} className="w-full px-4 py-2 border rounded-md focus:outline-none focus:border-blue-500" placeholder='Theater Name' disabled />
                </div>
                <div className="mb-4">
