                ...
                <form className="space-y-6" onSubmit={handleRegister}>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <Input name={"name"} onChange={handleChange} type={"text"} label="Name" color="white" />
                            {errors.name && (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <Input name={"city"} onChange={handleChange} type={"text"} label="City" color="white" />
                            {errors.city && (
                                <div className="mt-2 w-fit bg-red-100 p-1 px-2 h-8 rounded-full">
                        ...
                        <div className="relative">
                            ...
                            <input name="password" onChange={handleChange} type={showPassword ? "text" : "password"} autoComplete="current-password" className="text-white h-10 mt-1 p-3 w-full border border-gray-400 rounded-md focus:outline-none focus:ring-1 focus:ring-white bg-transparent" placeholder="Password" />
                        ...
                        <div className="relative">
                            ...
                            <input name="confirmPassword" onChange={handleChange} type={showConfirmPassword ? "text" : "password"} autoComplete="current-password" className="text-white h-10 mt-1 p-3 w-full border border-gray-400 rounded-md focus:outline-none focus:ring-1 focus:ring-white bg-transparent" placeholder="Confirm Password" />
                            <div className="absolute top-11 right-0 pr-3 flex items-center">
                                <button type="button" onClick={toggleConfirmPasswordVisibility} className="text-gray-300 focus:outline-none">
                                    {showConfirmPassword ? (
                                        <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path>
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M2.458 12C3.732 7.943 7.522 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.478 0-8.268-2.943-9.542-7z"></path>
                    ...
                    <div>
                        <Button type="submit" size="lg" fullWidth color="yellow">Sign up</Button></div>
                </form>
                <div className="text-center text-sm text-white">
                    <p className="mt-2">Already have an account? <Link to="/theater/login" className="font-medium text-white hover:bg-gray-900 bg-gray-800 p-1 rounded-md transition duration-200 ease-in-out hover:underline">Log in here</Link></p>
                </div>
            </div>
        </div>
    );
