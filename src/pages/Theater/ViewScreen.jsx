...
//   const [diamondRows, setDiamondRows] = useState(['A', 'B', 'C', 'D']);
//   const [goldRows, setGoldRows] = useState(['E', 'F', 'G', 'H']);
//   const [silverRows, setSilverRows] = useState(['I', 'J', 'K']);
...
//     switch (category) {
//       case 'diamond':
//         setDiamondRows([...diamondRows, String.fromCharCode(diamondRows.length + 65)]);
//         break;
//       case 'gold':
//         setGoldRows([...goldRows, String.fromCharCode(goldRows.length + 69)]);
//         break;
//       case 'silver':
//         setSilverRows([...silverRows, String.fromCharCode(silverRows.length + 73)]);
//         break;
//       default:
//         break;
//     }
...
//     switch (category) {
//       case 'diamond':
//         setDiamondRows(diamondRows.slice(0, -1));
//         break;
//       case 'gold':
//         setGoldRows(goldRows.slice(0, -1));
//         break;
//       case 'silver':
//         setSilverRows(silverRows.slice(0, -1));
//         break;
//       default:
//         break;
//     }
...
//       const seatId = `${row}${i}`;
//       seats.push(
//         <div key={seatId} className="inline-block mr-2 mt-5">
//           <button
//             onClick={() => handleSeatSelection(row, i)}
//             className={`w-6 h-6 border border-gray-300 rounded-full flex items-center justify-center ${
//               isSeatSelected(row, i) ? 'bg-blue-500 text-white' : ''
//             }`}
//           >
//             {isSeatSelected(row, i) ? '-' : '+'}
//           </button>
//           <label htmlFor={seatId} className="text-xs ml-1">
//             {i}
//           </label>
...
//       <div className="mb-4">
//         <h2 className="text-lg font-bold mb-2">Diamond Category</h2>
//         {diamondRows.map(row => (
//           <div key={row} className="flex items-center mb-2">
//             <button onClick={() => deleteRow('diamond')} className="mr-2 px-2 py-1 bg-red-500 text-white rounded">
//               Delete Row
//             </button>
//             <span className="text-xs mr-2">{row}</span>
//             {renderSeats(row, 'diamond')}
//             <button onClick={() => addRow('diamond')} className="ml-2 px-2 py-1 bg-green-500 text-white rounded">
//               Add Row
//             </button>
//           </div>
//         ))}
//       </div>
//       <div className="mb-4">
//         <h2 className="text-lg font-bold mb-2">Gold Category</h2>
//         {goldRows.map(row => (
//           <div key={row} className="flex items-center mb-2">
//             <button onClick={() => deleteRow('gold')} className="mr-2 px-2 py-1 bg-red-500 text-white rounded">
//               Delete Row
//             </button>
//             <span className="text-xs mr-2">{row}</span>
//             {renderSeats(row, 'gold')}
//             <button onClick={() => addRow('gold')} className="ml-2 px-2 py-1 bg-green-500 text-white rounded">
//               Add Row
//             </button>
//           </div>
//         ))}
//       </div>
//       <div className="mb-4">
//         <h2 className="text-lg font-bold mb-2">Silver Category</h2>
//         {silverRows.map(row => (
//           <div key={row} className="flex items-center mb-2">
//             <button onClick={() => deleteRow('silver')} className="mr-2 px-2 py-1 bg-red-500 text-white rounded">
//               Delete Row
//             </button>
//             <span className="text-xs mr-2">{row}</span>
//             {renderSeats(row, 'silver')}
//             <button onClick={() => addRow('silver')} className="ml-2 px-2 py-1 bg-green-500 text-white rounded">
//               Add Row
//             </button>
//           </div>
//         ))}
...
//             <li key={index}>{`${seat.row}${seat.seat}`}</li>
//           ))}
//         </ul>
//       </div>
//     </div>
